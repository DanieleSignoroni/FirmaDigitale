...
%> 
                  ...
                  <tr>
                    <td colspan="2" valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "PsnDatiFirmaDigitale", null, null); 
   label.setParent(PsnDatiFirmaDigitaleForm); 
%><label class="<%=label.getClassType()%>" for="AssociazioneDocumenti"><%label.write(out);%></label><%}%>
                  ...
                  <tr>
                    <td colspan="2" valign="top">
                      <!--<span class="ajaxgrid" id="AssociazioneDocumenti">--><% 
  WebAjaxGrid PsnDatiFirmaDigitaleAssociazioneDocumenti =  
     new com.thera.thermfw.web.WebAjaxGrid("PsnDatiFirmaDigitale", "AssociazioneDocumenti", 10, new String[]{"IdTipoDocumento", "IdAzienda", "TipoBolla", "XPosition", "YPosition", "Width", "Height", "Azienda.Descrizione", "TipoDocumento.Descrizione.Descrizione"}, "independent" , null, true, null,null,"A"); 
 ...
 PsnDatiFirmaDigitaleAssociazioneDocumenti.setOrderByClassAD(null); 
 PsnDatiFirmaDigitaleAssociazioneDocumenti.setOrderByWay("A"); 
 ...
 PsnDatiFirmaDigitaleAssociazioneDocumenti.addHidden("IdAzienda"); 
