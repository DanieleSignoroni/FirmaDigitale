...
public class AssociazioneTipoDocFirmaTM extends TableManager {
  ...
  /**
   * Attributo TIPO_BOLLA
   */
  public static final String TIPO_BOLLA = "TIPO_BOLLA";
  ...
  protected void initializeRelation() throws SQLException {
    ...
    addAttribute("TipoBolla", TIPO_BOLLA);
  ...
  private void init() throws SQLException {
    configure(TIPO_BOLLA + ", " + X_POSITION + ", " + Y_POSITION + ", " + WIDTH
         + ", " + HEIGHT + ", " + ID_AZIENDA + ", " + R_TIPO_DOC + ", " + STATO
