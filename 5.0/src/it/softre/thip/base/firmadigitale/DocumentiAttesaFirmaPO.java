...
public static Vector retrieveList(String where, String orderBy, boolean optimistic) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
   ...
   *
   */
  public void setDevice(DeviceInvioDocumenti device) {
    String oldObjectKey = getKey();
    String idAzienda = getIdAzienda();
    if (device != null) {
      idAzienda = KeyHelper.getTokenObjectKey(device.getKey(), 1);
    }
    setIdAziendaInternal(idAzienda);
    this.iDevice.setObject(device);
    setDirty();
    if (!KeyHelper.areEqual(oldObjectKey, getKey())) {
      setOnDB(false);
    }
  ...
  public void setIdDevice(String idDevice) {
    ...
    iDevice.setKey(KeyHelper.replaceTokenObjectKey(key , 2, idDevice));
    setDirty();
  }
  ...
  public String getIdDevice() {
    String key = iDevice.getKey();
    String objIdDevice = KeyHelper.getTokenObjectKey(key,2);
    return objIdDevice;
  }
  ...
  public void setEqual(Copyable obj) throws CopyException {
    ...
    iDevice.setEqual(documentiAttesaFirmaPO.iDevice);
  }
...
public Vector checkAll(BaseComponentsCollection components) {
  ...
  protected void setIdAziendaInternal(String idAzienda) {
    ...
    String key3 = iDevice.getKey();
    iDevice.setKey(KeyHelper.replaceTokenObjectKey(key3, 1, idAzienda));
  }
